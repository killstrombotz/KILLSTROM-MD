...
global.channelLink = "https://whatsapp.com/channel/0029VbCg36CBKfhshMEigq20";
global.ytch = "KILLSTROMBOTZ";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbCg36CBKfhshMEigq20'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/E1JbnDPnLGL2Z0e03aZqu2?mode=gi_t`
                }, { quoted: message });
                return;
            }
        }
