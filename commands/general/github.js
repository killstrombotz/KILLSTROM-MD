...
module.exports = {
    ...
    async execute(sock, msg, args, extra) {
        try {
            ...
            const repoUrl = 'https://github.com/killstrombotz/KILLSTROM-MD';
            const apiUrl = 'https://api.github.com/repos/killstrombotz/KILLSTROM-MD';
    ...
    headers: {
        'User-Agent': 'KILLSTROM-MD'
                ...
                fallbackMessage += `🔗 *Repository:* killstrombotz\n`; 
                fallbackMessage += `👨‍💻 *Owner:* KILLSTROM-MD\n`;
