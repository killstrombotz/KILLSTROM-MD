...
bmbtz({nomCom:"take",categorie: "Conversion", reaction: "💗"},async(origineMessage,zk,commandeOptions)=>{
...
bmbtz({ nomCom: "write", categorie: "Conversion", reaction: "☘️" }, async (origineMessage, zk, commandeOptions) => {
  const { ms, msgRepondu, arg, repondre, nomAuteurMessage } = commandeOptions;
...
bmbtz({nomCom:"photo",categorie: "Conversion", reaction: "☘️"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
